...
// ============================================
const CONFIG = {
  // Coloque sua API Key do Gemini aqui (GRATUITA!)
  ...
  // ============================================
  // NOTIFICAÇÃO DO ADMIN (TELEGRAM)
  // ============================================
  // Para receber notificações de vendas no Telegram:
  // 1. Fale com @BotFather no Telegram e crie um bot
  // 2. Copie o token e cole aqui
  // 3. Fale com @userinfobot para pegar seu Chat ID
  TELEGRAM_ENABLED: false, // Mude para true quando configurar
  TELEGRAM_BOT_TOKEN: 'SEU_TOKEN_AQUI',
  TELEGRAM_ADMIN_CHAT_ID: 'SEU_CHAT_ID_AQUI',
  
  // Arquivo para salvar dados de vendas (relatórios futuros)
