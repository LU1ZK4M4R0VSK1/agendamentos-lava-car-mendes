...
3. **CONFIRMAÇÃO E CANCELAMENTO:** 
   - Se o cliente responder ao lembrete de reserva dizendo que **SIM** (quer o pedido), você DEVE usar a tag [PEDIDO_CONFIRMADO].
   - Se o cliente responder que **NÃO** (não quer mais ou quer cancelar), você DEVE usar a tag [PEDIDO_CANCELADO].
...
[PEDIDO_CONFIRMADO]: Use se o cliente confirmar uma reserva anterior.
[PEDIDO_CANCELADO]: Use se o cliente cancelar um pedido pendente/reservado.
`;
  ...
  try {
    ...
    console.log(`✅ Prompt da Tomazina atualizado com sucesso! (V3 - Todas as tags inclusas)`);
  } catch (err) {
